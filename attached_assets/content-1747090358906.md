[Skip to content](https://vite.dev/config/server-options.html#VPContent)
...
## server.sourcemapIgnoreList [​](https://vite.dev/config/server-options.html\#server-sourcemapignorelist)
